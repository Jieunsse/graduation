...
export const vars = createGlobalTheme(':root', {
  ...
  color: {
    ...
    gridCardBg: '#0a0a0f',
    gridCardBorder: 'rgba(255, 255, 255, 0.08)',
    gridCardText: '#f5f7ff',
    gridCardSubtleText: 'rgba(255, 255, 255, 0.72)',
    gridCardAccent: '#ffffff',
    gridCardDivider: 'rgba(255, 255, 255, 0.28)',
...
export const lightVars = createGlobalTheme('.light', {
  color: {
    ...
    gridCardText: '#0f172a',
    gridCardSubtleText: '#334155',
    gridCardAccent: '#0b1220',
    gridCardDivider: 'rgba(15, 23, 42, 0.16)',
